      ...
      <nav className="fixed top-0 left-0 w-full z-50 backdrop-blur-xl bg-black/60 border-b border-white/5">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-4">
            {/* 
                RESUME LINK: 
                'href="/resume.pdf"' tells the browser to look in the public folder for a file named resume.pdf 
             */}
            <a
            ...
            >
              ...
              >
                ...
                {/* 
                    ...
                    'src="/profile.png"' tells the browser to look in the public folder for a file named profile.png 
                  */}
                <img
