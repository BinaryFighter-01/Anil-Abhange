...
const ChatAssistant: React.FC = () => {
  ...
  // 🔥 Call Vercel backend API instead of Gemini directly
  const sendMessageToAI = async (text: string) => {
    try {
      ...
      return "Oops! My AI brain is offline. Please try again later.";
    }
  };
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      <button
        ...
        className={`p-4 rounded-full shadow-2xl text-white transition-all duration-300 hover:scale-110 group relative ${
